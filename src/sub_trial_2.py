...
class ControlNode:
    def __init__(self):
        ...
        # self.vel_publisher_r = rospy.Publisher('control_speed',Float64,queue_size=10)
    ...
    def control_callback(self,arr):
        ...
        self.speed_r = self.speed_wo_enc
        if self.speed_r >= 480:
            self.speed_r = 480
        else:
            if self.speed_r <= -480:
    ...
    def subscribe(self):
        ...
        rospy.Subscriber('/control_speed',Float64,self.control_callback)
...
if __name__ == "__main__":
    ...
    if collect_data:
        df = pd.DataFrame(list(zip(lin_acc_cal_lst,ang_acc_lst,ang_vel_lst,position_lst,enc_l_lst,enc_r_lst,imu1_lst,imu2_lst,
                                   ...
                                   ref_vel_lst,ref_angle_lst,rpm_l_lst,rpm_r_lst,ang_vel_cal_lst,dt_lst)),
