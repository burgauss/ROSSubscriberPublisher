...
with open('data.csv','w',newline='') as file:
    ...
    writer.writerow(['x','theta','dx','d_theta','dt','x_dot','theta_dot','encoder_1_first','encoder_2_first','gain','mpu_1','mpu_2','error','encoder_1','encoder_2','pos_error','pos_pd','out','newspeed','newspeed1','newspeed2','P_pos','I_pos','D_pos'])
    while True:
        if ser.inWaiting()>0:
