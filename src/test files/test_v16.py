...
with open('data.csv','w',newline='') as file:
    ...
    writer.writerow(['r_rpm','l_rpm','v','e1','e2','ref_pos','x','theta','x_dot','theta_dot','encoder_1_first','encoder_2_first','mpu_1','mpu_2','error','encoder_1','encoder_2','pos_error','pos_pd','out','newspeed','newspeed1','newspeed2','P_pos','I_pos','D_pos'])
    while True:
...
#PID controller for inner loop
            ...
            writer.writerow([right_rpm,left_rpm,trans_vel,e1,e2,ref_pos,x,theta,x_dot,theta_dot,encoder_1_first,encoder_2_first,mpu_1,mpu_2,error,encoder_1,encoder_2,pos_error,pos_pd,out,newspeed,newspeed1,newspeed2,P_pos,I_pos,D_pos])
            #motor speed command
            try:
