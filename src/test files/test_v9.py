...
with open('data.csv','w',newline='') as file:
    ...
    writer.writerow(['x','theta','dx','d_theta','dt','x_dot','theta_dot','encoder_1_first','encoder_2_first','gain','mpu_1','mpu_2','error','encoder_1','encoder_2','pos_error','pos_pd','pos_speed','out','newspeed','newspeed1','newspeed2','Pterm','Iterm','Dterm'])
    while True:
        if ser.inWaiting()>0:
...
#PID controller for both
            ...
            newspeed1 = newspeed + 0*pos_speed
