...
with open('data.csv','w',newline='') as file:
    ...
    writer.writerow(['gain','mpu_1','mpu_2','error','encoder_1','encoder_2','pos_error','pos_pd','out','newspeed','newspeed1','newspeed2'])
    while True:
        if ser.inWaiting()>0:
...
#PID controller for both
            error = (1-gain)*angle_error + gain* pos_pd
            Pterm = Kp*error
            Iterm += Ki*error
